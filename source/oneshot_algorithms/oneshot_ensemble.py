...
def OneShotEnsemble(trainset, test_loader, client_idx_map, config, global_model, device):
    global_model.to(device)
    global_model.train()

    method_name = 'OneShotEnsemble'
    ...
    # global model
    global_model = Ensemble(model_list=local_models, weight_list=weights)
